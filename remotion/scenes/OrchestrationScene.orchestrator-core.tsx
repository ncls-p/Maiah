    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 80px rgba(37,173,197,0.13), inset 0 0 40px rgba(37,173,197,0.07)",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background: "radial-gradient(circle at 35% 28%, rgba(104,216,231,0.23), rgba(15,45,54,0.96) 45%, rgba(8,25,31,0.98))",
