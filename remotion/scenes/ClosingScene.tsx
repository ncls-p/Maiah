  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 0 0 80px rgba(37,173,197,0.025), 0 0 0 180px rgba(37,173,197,0.018), 0 0 190px rgba(37,173,197,0.11)",
      }}
    >
      <div
        style={{
      ...
      {[18, 142, 264].map((degrees, index) => {
        const angle = ((degrees + frame * (index === 1 ? -0.08 : 0.06)) * Math.PI) / 180;
        const radius = 331;
        return (
          <span
            key={degrees}
    ...
    <SceneLayer duration={duration} fadeOut={false}>
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(circle at 50% 42%, rgba(37,173,197,0.13), transparent 42%), linear-gradient(135deg, #071216, #0a1d23 55%, #071216)",
          opacity: holdOpacity,
        }}
      />
      <ClosingRings />
      ...
      >
        <Img src={staticFile("deodis-logo.png")} style={{ width: "100%", height: "100%", objectFit: "contain" }} />
      </div>
        ...
        >
          ...
          <span
            ...
            style={{
              ...
              height: 2,
              borderRadius: 10,
              background: "linear-gradient(90deg, rgba(37,173,197,0), #68d8e7 18%, #68d8e7 82%, rgba(37,173,197,0))",
      ...
      >
        Built with care by Deodis — for teams ready to turn AI into work that matters.
      </p>
