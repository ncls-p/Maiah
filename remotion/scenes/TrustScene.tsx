...
import { CheckIcon,FingerprintIcon,KeyRoundIcon,LockKeyholeIcon,ScrollTextIcon,ShieldCheckIcon,UsersRoundIcon } from "lucide-react";
...
function ControlRow({ title, detail, icon: Icon, code, index }: (typeof controls)[number] & { index: number }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <div style={{ fontSize: 17, fontWeight: 750, letterSpacing: "-0.025em" }}>{title}</div>
        <div style={{ marginTop: 5, color: "rgba(7,18,22,0.55)", fontSize: 12 }}>{detail}</div>
      </div>
      <div
        style={{
          padding: "7px 10px",
      ...
      <div
        style={{
          ...
          background: complete > 0.5 ? COLORS.azureDark : "rgba(37,173,197,0.08)",
    ...
    <SceneLayer duration={duration} light>
      ...
      >
        <div
          ...
          style={{
            ...
            height: 1050,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(37,173,197,0.19), rgba(37,173,197,0.04) 42%, transparent 69%)",
          }}
        />
        <div
          aria-hidden="true"
          style={{
            ...
            inset: 0,
            opacity: 0.32,
            backgroundImage: "linear-gradient(rgba(7,18,22,0.045) 1px, transparent 1px), linear-gradient(90deg, rgba(7,18,22,0.045) 1px, transparent 1px)",
            backgroundSize: "80px 80px",
            maskImage: "radial-gradient(ellipse 74% 72% at 78% 48%, black 10%, transparent 78%)",
          }}
        />
      </div>

      <div style={{ position: "absolute", left: 92, top: 72, ...rise(frame, 4) }}>
      ...
      <div style={{ position: "absolute", left: 105, top: 238, width: 620 }}>
        ...
        <div style={{ ...rise(frame, 45, 28, 22), marginTop: 48 }}>
          ...
          >
            Multi-tenant by design. Human control by default. Production-grade from the first workspace to the hundredth.
          </p>
        </div>
        <div
          style={{
