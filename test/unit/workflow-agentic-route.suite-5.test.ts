...
import { createWorkflowAgenticModelFixture,request } from "./workflow-agentic-route.suite-3.fixture";
...
describe("workflow agentic route", () => {
  ...
  it("uses the workflow builder assistant selected by an administrator", async () => {
    ...
    mocks.getConfiguredWorkflowBuilderAgentId.mockResolvedValue(configuredAgentId);
