...
description: Production-ready CSS transitions for web apps. Use when implementing UI motion for badges, dropdowns, modals, panels, page slides, card resize, number/text/icon swaps, success checks, avatar hovers, form error shakes, search clear, skeleton/reveal, shimmer text, sliding tabs, tooltips, staggered text, 3D card tilt, plus-to-menu FABs, accordions/collapsibles/disclosures. Triggers on "add a transition", "animate the dropdown/modal", "make it open smoothly", "swap icon/text", "page slide", "stagger animation", "fade between", "success animation", "shake on invalid", "hover lift", "skeleton loader", "loading shimmer", "segmented control", "tooltip", "reveal text", "cursor glare", "FAB morph", "expand/collapse". Also supports transitions reveal, review, apply, refine.
---
