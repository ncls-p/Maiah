...
export const ROLE_BINDING_RESOURCE_TYPES = [
  "organization",
  "workspace",
  ...ACCESS_RESOURCE_TYPES,
] as const;

export type RoleBindingResourceType =
  (typeof ROLE_BINDING_RESOURCE_TYPES)[number];
