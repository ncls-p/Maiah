...
const TENANT_USER_PERMISSIONS: Permission[] = ["workspaces.get", "providers.viewMetadata", "models.view", "models.invoke", "agents.list", "agents.get", "agents.chat", "agents.create", "agents.update", "agents.delete", "agents.test", "agents.delegate", "agentVersions.create", "tools.view", "tools.configure", "tools.executeRestricted", "mcpServers.get", "mcpServers.manage", "knowledgeBases.viewAllowed", "knowledgeBases.manage", "conversations.create", "conversations.viewOwn", "marketplaceItems.view", "marketplaceItems.install", "marketplaceItems.publish", "apiKeys.manageOwn", "workflows.view", "workflows.create", "workflows.update", "workflows.delete", "workflows.execute"];
...
export const SYSTEM_ROLES: Omit<Role, "createdAt" | "updatedAt">[] = [
  {
    ...
    description: "Full control over the organization and every project it contains.",
    permissions: [...new Set(["organization.get", "organization.update", "workspaces.get", "workspaces.create", "workspaces.update", "members.manage", "teams.manage", "roles.manage", ...TENANT_ADMIN_PERMISSIONS])],
    isSystem: true,
  },
  {
    id: "", // assigned by DB
    ...
    permissions: ["organization.get", "organization.update", "workspaces.get", "workspaces.create", "workspaces.update", "members.manage", "teams.manage", "roles.manage", "audit.view"],
    isSystem: true,
  },
  {
    id: "",
  ...
  },
  {
    ...
    permissions: ["workspaces.get", "providers.viewMetadata", "models.view", "agents.list", "agents.get", "tools.view", "mcpServers.get", "knowledgeBases.viewAllowed", "marketplaceItems.view", "usage.view", "audit.view", "workflows.view"],
    isSystem: true,
  },
];
