...
export const agentSkillBindingRelations = relations(agentSkillBindings, ({ one }) => ({
  agentVersion: one(agentVersions, {
...
export const toolConnectorRelations = relations(toolConnectors, ({ one, many }) => ({
  workspace: one(workspaces, {
...
export const toolConnectionRelations = relations(toolConnections, ({ one, many }) => ({
  workspace: one(workspaces, {
...
export const toolConnectionRequirementRelations = relations(toolConnectionRequirements, ({ one }) => ({
  workspace: one(workspaces, {
...
export const userToolSettingRelations = relations(userToolSettings, ({ one }) => ({
  workspace: one(workspaces, {
