...
export function ChatLayout({
  ...
  return (
    <div className="flex h-full min-h-0">
      {sidebarOpen ? (
        <aside className="hidden h-full min-h-0 w-80 shrink-0 border-r border-border/70 bg-background/90 backdrop-blur-xl shadow-sm md:flex animate-in-slide-right">
