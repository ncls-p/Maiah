...
export type CodeWorkspaceArtifactCardViewModel = Extract<ReturnType<typeof useCodeWorkspaceArtifactCardController>, { kind: "ready" }>;
export function CodeWorkspaceArtifactCardView({ model }: { model: CodeWorkspaceArtifactCardViewModel }) {
  const { currentArtifact, deletePath, deleteSelectedFile, publishOpen, savingFile, setDeletePath, setPublishOpen, t, variant, workspaceId } = model;
  return (
    <>
