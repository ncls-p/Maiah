...
export function ChatFileAttachmentCard({ attachment }: { attachment: ChatFileAttachment }) {
  ...
  return (
    <>
      ...
      <FilePreviewDialog open={preview.previewOpen} onOpenChange={preview.setPreviewOpen} fileName={attachment.fileName} url={attachment.url} subtitle={`${fileSummary} · ` + t("extractedChars", { count: attachment.extractedTextChars })} previewText={preview.previewText} previewError={preview.previewError} loadingPreview={preview.loadingPreview} />
    </>
  );
}
