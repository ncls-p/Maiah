...
export type GitHubPublishDialogViewModel = Extract<ReturnType<typeof useGitHubPublishDialogController>, { kind: "ready" }>;
export function GitHubPublishDialogView({ model }: { model: GitHubPublishDialogViewModel }) {
