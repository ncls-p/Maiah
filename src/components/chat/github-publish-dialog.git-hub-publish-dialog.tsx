...
import { BUTTON_TYPE,GitHubBranchOption,GitHubConnectionOption,GitHubPublishResult,GitHubRepositoryOption,GitHubStatusPayload,GithubIcon,OUTLINE_VARIANT,canAttemptPublishToRepository,formatLastSynced,hasLimitedRepositoryAccess,requestGitHubJson } from "./github-publish-dialog.button-type";

export function GitHubPublishDialog({ artifact, workspaceId, open, onOpenChangeAction }: { artifact: CodeWorkspaceArtifact; workspaceId?: string; open: boolean; onOpenChangeAction: (open: boolean) => void }) {
