...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent text-sm font-medium whitespace-nowrap outline-none select-none transition-[background-color,border-color,color,box-shadow,scale] duration-150 ease-out focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/20 disabled:pointer-events-none disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-destructive/15 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[var(--control-shadow)] hover:bg-primary/90 hover:shadow-[var(--control-shadow-hover)]",
        outline:
          "border-transparent bg-card text-foreground shadow-[var(--control-shadow)] hover:bg-muted hover:shadow-[var(--control-shadow-hover)] aria-expanded:bg-muted",
        secondary:
          "border-transparent bg-secondary text-secondary-foreground shadow-[var(--control-shadow)] hover:bg-secondary/75 hover:shadow-[var(--control-shadow-hover)] aria-expanded:bg-secondary",
