...
export function RagSettingsFieldsSection2({ model }: { model: RagSettingsViewModel }) {
  const { discovering, modelValue, rerankingModels, selectModel, setSettings, settings, t } = model;
  return (
