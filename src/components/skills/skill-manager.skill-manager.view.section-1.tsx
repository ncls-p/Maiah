...
export function SkillManagerSection1({ model }: { model: SkillManagerViewModel }) {
  const { canManageTenantGlobals, installCommand, installGlobal, installOpen, installSkill, installing, preview, previewSkill, previewWorkspaceId, previewing, setInstallCommand, setInstallGlobal, setInstallOpen, setPreview, setPreviewToken, setPreviewWorkspaceId, t, workspaceId } = model;
  return (
