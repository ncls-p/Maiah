...
import { formatNextRun,statusToneClass,statusVariant } from "./scheduled-task-manager.daily-frequency";
import type { ScheduledTaskManagerViewModel } from "./scheduled-task-manager.scheduled-task-manager.view";
export function ScheduledTaskManagerSection2({ model }: { model: ScheduledTaskManagerViewModel }) {
  const { deletingTaskId, enabledTasks, formatFrequency, loadError, loadTasks, loading, locale, nextTask, setCreateOpen, setPendingDeleteTask, statusLabels, successRate, t, tasks, toggleTask, updatingTaskIds } = model;
  return (
