...
import { PlatformUser,STEP_INDEX,ShareOptionCard,ShareStep,ShareableResource,previewQueryParams } from "./resource-share-dialog.share-step";

export function ResourceShareDialog({ resource, workspaceId, open, onCloseAction, onSuccessAction }: { resource: ShareableResource | null; workspaceId: string | null; open: boolean; onCloseAction: () => void; onSuccessAction?: () => void }) {
