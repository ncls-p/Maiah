...
export function useWorkflowConfigurationRenderer(model: WorkflowBuilderViewModel) {
  const { agents, removeSelectedNode, selectedNode, t, updateParameters, updateSelectedNode } = model;
