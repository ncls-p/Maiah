...
import { createCodeWorkspaceFromFiles,importCodeWorkspaceFile,listCodeWorkspaceFiles,readCodeWorkspaceFile,writeCodeWorkspaceFile } from "@/modules/code-workspace/storage";
...
import { calculateExpression,calculatorInputSchema,codeSandboxInputSchema,codeWorkspaceCreateInputSchema,codeWorkspaceProjectInputSchema,codeWorkspaceReadFileInputSchema,codeWorkspaceReplaceTextInputSchema,codeWorkspaceWriteFileInputSchema,currentTimeInputSchema,htmlArtifactInputSchema,httpFetchInputSchema,imageGenerationInputSchema,searchWebWithSearxng,webSearchInputSchema } from "./builtin-tool-primitives";
import { BuiltInToolDefinition,MEDIUM_RISK_LEVEL,replaceCodeWorkspaceText,requireCodeWorkspaceContext } from "./builtin-tools.built-in-tool-execution-context";
export const builtInToolsPart1 = [
  ...
  },
  {
    ...
    description: "Search the web with today's date automatically included. When ok is true, use the returned summary and results to answer current-events and web questions.",
  ...
  },
  {
    ...
    description: "Render interactive HTML/CSS/JS previews in chat for UI mockups, diagrams, cards, and demos.",
    riskLevel: MEDIUM_RISK_LEVEL,
    category: "Create",
  ...
  },
  {
    ...
    description: "Generate one image from a text prompt using the project image model configured by an administrator. Omit size to use the administrator default.",
    riskLevel: MEDIUM_RISK_LEVEL,
    category: "Create",
  ...
  },
  {
    ...
    description: "Run Python, Node.js, or Bash in a wiped sandbox with broad data/science/document libraries and safe uploaded-document access.",
    riskLevel: "high",
    category: "Code",
  ...
  },
  {
    ...
    description: "Start a live static HTML/CSS/JS code workspace from files generated by the model, with preview and ZIP download in chat.",
    riskLevel: MEDIUM_RISK_LEVEL,
    category: "Code",
  ...
  },
  {
    ...
    description: "List files and return the live chat artifact for a static HTML/CSS/JS code workspace.",
    riskLevel: "low",
    category: "Code",
  ...
  },
  {
    ...
    description: "Read a text file from an uploaded code workspace before editing it.",
    riskLevel: "low",
    category: "Code",
  ...
  },
  {
    ...
    description: "Create or replace a text file, or copy an uploaded chat attachment into a code workspace, then return the updated live preview artifact.",
    riskLevel: MEDIUM_RISK_LEVEL,
    category: "Code",
  ...
  },
  {
    ...
    description: "Patch a code workspace text file by replacing exact text; prefer this over rewriting large files.",
    riskLevel: MEDIUM_RISK_LEVEL,
    category: "Code",
    inputSchema: codeWorkspaceReplaceTextInputSchema,
    execute: async (toolInput: z.infer<typeof codeWorkspaceReplaceTextInputSchema>, context) => replaceCodeWorkspaceText(toolInput, requireCodeWorkspaceContext(context)),
  },
