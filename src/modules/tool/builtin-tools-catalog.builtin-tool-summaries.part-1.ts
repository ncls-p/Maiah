...
export const BUILTIN_TOOL_SUMMARIESPart1: BuiltInToolSummary[] = [
  ...
  },
  {
    ...
    description:
      "Run Python, Node.js, or Bash in a wiped sandbox with web access and data, chart, image, and CPU PyTorch libraries. Generated files are automatically collected and shown to the user.",
    riskLevel: "high",
    category: "Code",
  },
  {
