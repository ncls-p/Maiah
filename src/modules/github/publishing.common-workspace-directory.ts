...
import {
  ...
  encodeRefPath,
  getUserRepository,
} from "./publishing.sync-git-hub-installation";
...
export async function getGitRef(input: {
  token: string;
  owner: string;
  repo: string;
  branch: string;
...
export async function gitRefExists(input: {
  token: string;
  owner: string;
  repo: string;
  branch: string;
...
export async function createGitRef(input: {
  token: string;
  owner: string;
  repo: string;
  branch: string;
...
export async function getCommitTreeSha(input: {
  token: string;
  owner: string;
  repo: string;
  commitSha: string;
...
export async function initializeEmptyRepository(input: {
  token: string;
  owner: string;
  repo: string;
  branch: string;
