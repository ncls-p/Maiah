...
type BuiltinToolPackage = BuiltinToolPackageDefinition & {
	tools: BuiltinTool[];
};
...
function buildBuiltinToolPackages(tools: BuiltinTool[]): BuiltinToolPackage[] {
...
function BuiltinToolPackageCard({
	toolPackage,
	bindings,
	packageLabel,
	description,
