...
import { approvalRiskLevels,approvalSources,parseTextList } from "./model-advanced-fields.approval-risk-levels";
import type { AgentForm } from "./types";
import { defaultGenParams } from "./types";

export function ModelAdvancedFields({ form, setFormAction: setForm, onResetAction: onReset }: { form: AgentForm; setFormAction: (fn: (prev: AgentForm) => AgentForm) => void; onResetAction?: () => void }) {
  ...
  return (
    <div className="space-y-4">
      <FieldGroup className="grid gap-4 sm:grid-cols-2">
        ...
        <Field>
          <FieldLabel htmlFor="agent-response-format" help={t("responseFormatHelp")}>
            {t("responseFormat")}
          </FieldLabel>
          <FieldContent>
            <Select
        ...
        <Field>
          <FieldLabel htmlFor="agent-frequency-penalty" help={t("frequencyPenaltyHelp")}>
            {t("frequencyPenalty")}
          </FieldLabel>
          <FieldContent>
            <Input
        ...
        <Field className="sm:col-span-2">
          <FieldLabel htmlFor="agent-guardrail-topics">{t("blockedTopics")}</FieldLabel>
          <FieldContent>
            <Textarea
