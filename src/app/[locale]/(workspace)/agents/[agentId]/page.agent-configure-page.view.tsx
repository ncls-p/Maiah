...
type ViewModel = Extract<ReturnType<typeof useAgentConfigurePageController>, { kind: "ready" }>;
export function AgentConfigurePageView({ model }: { model: ViewModel }) {
  const { activeTab, agent, builtinBindings, builtinTools, canEdit, capabilitiesCount, delegationCandidates, delegationConfig, delegationCount, deleting, form, handleClone, handleDelete, handleLogoChange, hasModel, knowledgeBases, mcpBindings, mcpServers, mcpTools, models, permissions, providers, saveCapabilities, saveEssential, saveOrchestration, saving, selectedKnowledgeIds, selectedSkillIds, setActiveTab, setBuiltinBindings, setDelegationConfig, setForm, setMcpBindings, setSelectedKnowledgeIds, setSelectedSkillIds, setShowDeleteDialog, showDeleteDialog, skills, t } = model;
  return (
