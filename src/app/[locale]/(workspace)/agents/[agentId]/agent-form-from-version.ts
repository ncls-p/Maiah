...
export function buildAgentFormFromVersion(
  ...
  return {
    ...
    accessScope: agent.access?.scope ?? "private",
    accessTeamId: agent.access?.teamId ?? "",
    originalAccessScope: agent.access?.scope ?? "private",
    originalAccessTeamId: agent.access?.teamId ?? "",
