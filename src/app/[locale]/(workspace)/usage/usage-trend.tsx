        ...
        >
          {points.map((point) => {
            ...
            return (
              ...
              >
                <div
                  className="min-h-1 flex-1 rounded-t-sm bg-chart-1 transition-opacity group-hover:opacity-75"
                  style={{ height: `${Math.max(2, inputHeight)}%` }}
                />
                <div
                  className="min-h-1 flex-1 rounded-t-sm bg-chart-2 transition-opacity group-hover:opacity-75"
                  style={{ height: `${Math.max(2, outputHeight)}%` }}
                />
              </div>
            );
          })}
