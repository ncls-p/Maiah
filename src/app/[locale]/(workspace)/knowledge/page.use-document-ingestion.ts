...
export function useKnowledgeDocumentIngestion(input: { workspaceId: string | null; selectedId: string | null; selectedBaseCanEdit: boolean; loadDocuments: () => Promise<void> }) {
  ...
  return { docForm, setDocForm, dragActive, setDragActive, documentInputRef, folderInputRef, uploadingCount, lastUpload, ingestFromContent, ingestFiles, handleFileDrop, ingestSelectedFiles };
}
