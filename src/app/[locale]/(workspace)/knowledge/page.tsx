						...
						{canManageTenantGlobals ? (
							<div className="flex items-start gap-3 rounded-lg border border-border/70 bg-muted/20 p-3">
								...
								<div className="grid gap-1.5 leading-none">
									<Label htmlFor="knowledge-global">
										Make visible to everyone
									</Label>
									<p className="text-xs text-muted-foreground">
										Leave unchecked to keep this knowledge base scoped to your
										account.
									</p>
								</div>
							</div>
								...
								<div className="min-w-0">
									<div className="flex min-w-0 items-center gap-2">
										...
										{selectedBase ? (
											...
											>
												{selectedBase.isGlobal ? "Tenant" : "Private"}
											</Badge>
										) : null}
									</div>
