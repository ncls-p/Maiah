...
export function KnowledgeMainSection1({ model }: { model: KnowledgePageViewModel }) {
  const { attachAgents, attachAgentsError, attachBaseToAgent, attachOpen, attachingAgentId, loadingAttachAgents, openAttachDialog, selectedBaseCanEdit, setAttachOpen, t, tCommon } = model;
  return (
