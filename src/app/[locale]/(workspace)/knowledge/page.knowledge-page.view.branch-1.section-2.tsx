...
export function KnowledgeMainSection2({ model }: { model: KnowledgePageViewModel }) {
  const { canManageKnowledgeBases, canManageModels, canManageTenantGlobals, discoveringRagModels, editBaseForm, editingBase, ragModels, setEditBaseForm, setEditingBase, t, tCommon, updateBase } = model;
  return (
