...
export function RagConfigFields({ idPrefix, config, onChange, canManageModels, models, discoveringModels }: { idPrefix: string; config: RagConfig; onChange: (config: RagConfig) => void; canManageModels: boolean; models: RagModelOption[]; discoveringModels: boolean }) {
