...
export async function GET(
	...
	try {
		...
		logger.error("Failed to read code workspace file", {}, error as Error);
		return NextResponse.json(
...
export async function PUT(
	...
	try {
		...
		logger.error("Failed to write code workspace file", {}, error as Error);
		return NextResponse.json(
			{ error: "Internal server error" },
			{ status: 500 },
		);
...
export async function DELETE(
	...
	try {
		...
		logger.error("Failed to delete code workspace file", {}, error as Error);
		return NextResponse.json(
			{ error: "Internal server error" },
			{ status: 500 },
		);
