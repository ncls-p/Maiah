...
export default function ChatPage() {
  ...
  if (agents.length === 0) {
    return (
      <div className="mx-auto flex h-full w-full max-w-3xl items-center px-4 animate-in-up">
        <Empty className="min-h-80 w-full surface-panel">
          <EmptyHeader>
            <EmptyMedia variant="icon" className="glow-primary-hover">
    ...
    >
      ...
      <section className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 sm:px-4 sm:py-8">
        {!loadingMessages && messages.length === 0 ? (
          <div className="mx-auto flex h-full w-full max-w-4xl flex-col items-center justify-center py-16 animate-in-fade">
            <Empty className="min-h-64 border-0 bg-transparent p-6">
              <EmptyHeader>
                <EmptyMedia
                  variant="icon"
                  className={cn(
                    "relative bg-card/90 shadow-lg ring-1 transition-all duration-300 hover:shadow-xl hover:-translate-y-1",
                    canChat
                      ? "bg-primary/5 ring-primary/20 glow-primary-hover"
                      : "ring-border/70",
                  )}
                >
                  <BotIcon
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {[
                      ...
                      <Button
                        ...
                        className="transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 animate-in-fade"
