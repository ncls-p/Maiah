...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  const copy = isFrench
    ? {
        ...
        description: "Réessayez. Si le problème persiste, transmettez la référence ci-dessous à votre administrateur.",
        reference: "Référence",
        retry: "Réessayer",
      }
    : {
        title: "Something went wrong",
        description: "Try again. If the problem continues, share the reference below with your administrator.",
        reference: "Reference",
        retry: "Try again",
      };
