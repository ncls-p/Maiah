...
export const FALLBACK_SYSTEM_PROMPT_EN = "Respond clearly and concisely. Follow the user's instructions.";

/** Neutral runtime fallback when no system prompt is set (FR). */
export const FALLBACK_SYSTEM_PROMPT_FR = "Réponds de façon claire et concise. Suis les instructions de l'utilisateur.";
