...
- **Organisations partageant des membres** : une identité déjà importée de la même source (même identifiant et même e-mail) est réutilisée, sans reprendre ses identifiants ni ses sessions ; toute autre collision reste refusée. Plusieurs organisations peuvent ainsi être importées successivement sur la même cible.
